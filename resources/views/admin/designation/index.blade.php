...
@section('content')
    ...
    <div class="card">
        <div class="card-header">
            <h3 class="card-title">Designation List
                ...
                @if(hasPermission('add_staff_designation'))
    ...
    <!--Add Modal -->
    <form action="{{route('admin.designation.store')}}" method="post" id="add_form">
        @csrf
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input maxlength="31" type="text" class="form-control entertxtOnly" placeholder="enter designation"
                                           name="add_name"
                                           id="add_name">
                                </div>
                            </div>
    ...
    <form method="post" id="edit_form">
        ...
        <div class="modal fade" id="edit_modal" tabindex="-1" role="dialog" aria-labelledby="addModalLabel"
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="addModalLabel">Edit Designation</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
    ...
    <script>
        $(document).ready(function () {
            ...
            $('#edit_form').on('submit', function (e) {
                ...
                var route = "{{route('admin.designation.update',['designation'=>':designation'])}}";
                route = route.replace(':designation', id);
                $.ajax({
                    type: 'POST',
                    url: route,
                    data: new FormData(this),
