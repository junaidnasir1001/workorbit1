...
class ClientContactPersonController extends Controller
{
    ...
    public function store(Request $request, Clients $client)
    {
        try {
            ...
            $client->contact_person()->save($contact_person);
     ...
     * @return \Illuminate\Http\Response
     */
    public function update(Request $request, Clients $client, ContactPerson $contact_person)
    {
        try {
     ...
     * @return \Illuminate\Http\JsonResponse
     */
    public function destroy(Clients $client, ContactPerson $contact_person)
    {
        try {
    ...
    public function showData(Request $request, Clients $client)
    {
        ...
        $contact_persons = $client->contact_person;
        return view('admin.clients.contact_person.list', compact('contact_persons', 'client'))->render();
    }
}
