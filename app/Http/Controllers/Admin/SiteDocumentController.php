...
class SiteDocumentController extends Controller
{
    ...
    public function index(Site $site)
    {
        ...
        return view('admin.site.document.list', compact('documents', 'site'))->render();
    }
     ...
     * @return \Illuminate\Http\JsonResponse
     */
    public function update(Request $request, Site $site, Document $document)
    {
        try {
     ...
     * @return \Illuminate\Http\JsonResponse
     */
    public function destroy(Site $site, Document $document)
    {
        try {
    ...
    public function download(Site $site, Document $document)
    {
        try {
