...
@section('content')
    ...
    <div class="card">
        <div class="card-header">
            <h3 class="card-title">Permissions List
                ...
                <a href="javascript:;" class="btn btn-outline-primary btn-md btn-flat ml-2" data-toggle="modal"
                   data-target="#add_modal"><i
                        class="fa fa-plus"></i> Add Permissions</a>
            </h3>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input maxlength="50" type="text" class="form-control entertxtOnly" placeholder="Enter Type Name"
                                           name="add_name"
                                           id="add_name">
                                </div>
                            </div>
    ...
    <script>
        $(document).ready(function () {
            ...
            $('#edit_form').on('submit', function (e) {
                ...
                var route = "{{route('admin.permission.update',['permission'=>':permission'])}}";
                route = route.replace(':permission', id);
                $.ajax({
                    type: 'POST',
                    url: route,
                    data: new FormData(this),
