...
<div class="card card-info">
    <div class="card-header">
        <h3 class="card-title">Contact Person List
            ...
            @if(hasPermission('add_site_contact_person'))
    ...
    <div class="card-body">
        ...
        @if(hasPermission('site_contact_person_list'))
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control entertxtOnly" placeholder="Enter Job Title"
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input class="form-control EnterOnlyNumber" placeholder="Enter Phone Number"
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input type="email" class="form-control"
                                       name="add_contact_person_email" placeholder="Enter Email"
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input type="email" class="form-control"
                                       name="edit_contact_person_email" placeholder="Enter Email"
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input maxlength="31" type="text" class="form-control"
                                       name="edit_contact_person_postal_code" placeholder="Enter Postal Code"
