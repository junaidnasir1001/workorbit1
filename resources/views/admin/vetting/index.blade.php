...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-body">
        @if(hasPermission('staff_vetting_list'))
    ...
    <!--Add Modal -->
    <form action="{{route('admin.vetting.store')}}" method="post" id="add_form">
        @csrf
    ...
    <script>
        $(document).ready(function () {
            ...
            $('#edit_form').on('submit', function (e) {
                ...
                var route = "{{route('admin.vetting.update',['vetting'=>':vetting'])}}";
                route = route.replace(':vetting', id);
                $.ajax({
                    type: 'POST',
                    url: route,
                    data: new FormData(this),
